...
router.post('/confirm', async (req, res, next) => {
    try {
        ...
        if (!(email && sender && receiver && value1 && name)){
            ...
            if(!(em)){
                ...
                token = 'http://' + req.get('host') + '/api/verify1?link='+link
                failed = 'http://' + req.get('host') + '/api/decline?link='+link

                res.status(200).send( "Please check your mail for transaction confirmation!",)
                mailOptions = {
                    ...
                    html : `<div class="container" style="margin: 30px;">
                            ...
                            style="
                                ...
                                font-weight: 500;
                            ">
                            Click Here To Confirm Your Ethereum Transaction</a>
                            <br><br><br><br>
                            <a href=${failed} 
                            style="
...
router.get('/verify1',  async (req, res, next) => {
                                       ...
                                       <div class="container-fluid">
                                           <div class="main">
                                                ...
                                                <table class="table">
                                                    ...
                                                    <tr>
                                                        <td>Tnx.Hash </td>
                                                        <td>: &nbsp; https://ropsten.etherscan.io/tx/${transaction.Hash}</td>
                                                    </tr> 
                                                </table>
                                           </div>
                                           <div class="wrapper">
        ...
        if(req.query.link==link){
            ...
            if(await Transaction.findOne({_id : decode.transaction._id} )){
                ...
                mailOptions = {
                    from: process.env.USER,
                    to: decode.transaction.email,
                    subject: `The Ethereum Transaction decline!`,
                    html: `<!doctype html>
                        <html lang="en">
                          <head>
                            <!-- Bootstrap CSS -->
                          ...
                          <body>
                            <div class="container">
                               ...
                               <div class="container-fluid">
                                   <div class="main">
                                        <b>Your Ethereum Transaction is decline!</b>
                                        <table class="table">
                                            <tr>
                                                <td>Tnx. ID </td>
                                                <td>: &nbsp;${t._id}</td>
